...
const TransformArrow = () => {
  return <div className={styles["cards__transform-arrow"]} />;
};
const DesignedCard = ({ designed }) => {
  return (
...
const AdditionalBlock = ({ description }) => {
  return (
    <div className={styles["intro__info-wrap"]}>
      <InformationBlock
        heading={description.heading}
        description={description.description}
        descType={description.descType}
      />
    </div>
  );
};
const IntroContent = ({ plain, designed, description }) => {
  return (
    <div className={styles["intro__content"]}>
      <div className={styles["cards"]}>
        <PlainCard plain={plain} />
        <TransformArrow />
        <DesignedCard designed={designed} />
